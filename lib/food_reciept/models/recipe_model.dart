...
List<RecipeItems> recipeItems = [
  RecipeItems(
    ...
    image: 'assets/food_recipe/sald_mix.png',
    name: 'Salad Mix',
    rate: 4,
    calorie: 320,
    reviews: "24",
  ...
  RecipeItems(
    ...
    wonerName: "Natasha Evelyn",
    image: 'assets/food_recipe/Shrimp_Kale.png',
    name: 'Shrimp Kale',
    rate: 4,
    calorie: 2200,
    reviews: "33",
  ...
  RecipeItems(
    ...
    wonerName: "",
    image: 'assets/food_recipe/ckicken_salad.png',
    name: 'Chicken Salad',
    rate: 4.3,
    weight: 250,
    calorie: 240,
  ...
  RecipeItems(
    image: 'assets/food_recipe/mushroom_salad.png',
    name: 'Mushroom salad',
    rate: 5.0,
  ...
  RecipeItems(
    image: 'assets/food_recipe/grilled_chicken_salad.jpg',
  ...
  RecipeItems(
    image: 'assets/food_recipe/thai salad.png',
    name: 'Thai Salad',
    rate: 4.9,
    fav: false,
    reviews: '52',
